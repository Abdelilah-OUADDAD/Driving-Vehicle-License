...
namespace DVLDProject
{
    ...
    {
        public frmStreetTestAppointment(int LDLApplicant)
        {
            InitializeComponent();
        ...
        private void _FillDataGrid()
        {
            ...
            {
                if ((int)row[1] == 3 && (int)row[2] == AppID)
        ...
        private void taskTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                frmSchedulePassStreetTest frm = new frmSchedulePassStreetTest((int)dataGridView1.CurrentRow.Cells[0].Value, AppID, ClassName, FullName,
