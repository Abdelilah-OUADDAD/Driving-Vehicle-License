...
{
    public partial class frmSchedulePassWrittenTest : Form
    {
        public frmSchedulePassWrittenTest()
        {
            InitializeComponent();
        }

        public frmSchedulePassWrittenTest(int TestAppointmentID, int AppID, string ClassName, string FullName, DateTime AppDate, int CreatedByUserID)
        {
            InitializeComponent();
            ...
            ctrlSchedulePassTest1.TestTypeID = 2;
            ctrlSchedulePassTest1.PaidFees = 20;
        }
