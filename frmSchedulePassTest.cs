...
{
    public partial class frmSchedulePassTest : Form
    {
        

        public frmSchedulePassTest()
        {
            InitializeComponent();
        }

        public frmSchedulePassTest(int TestAppointmentID,int AppID, string ClassName, string FullName, DateTime AppDate,int CreatedByUserID)
        {
            InitializeComponent();
            ...
            ctrlSchedulePassTest1.TestTypeID = 1;
            ctrlSchedulePassTest1.PaidFees = 10;
        }

        private void frmSchedulePassTest_Load(object sender, EventArgs e)
        {
